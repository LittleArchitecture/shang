package com.shang.sys.service;

import java.util.Collections;
import java.util.List;

import com.shang.sys.dao.SysUserDao;
import com.shang.sys.facade.SysUserFacade;
...
@com.alibaba.dubbo.config.annotation.Service(interfaceClass=com.shang.sys.facade.SysUserFacade.class, protocol = {"rest", "dubbo"})
